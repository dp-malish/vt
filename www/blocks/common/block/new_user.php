...
//new user
$new_user=$Cash->IsSetCacheFile(1100,'new_user.html');
if($new_user=='0'){
$Cash->StartCache();
...
$new_user.='<tr><td class="td_linc">'.$res["username"].'</td><td class="td_date  align-center">'.$res_date.'</td></tr>';
}mysql_free_result($result);
$new_user.='</table></div>';
echo $new_user;
$Cash->StopCache('new_user.html');
}?>