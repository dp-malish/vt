...
$title='Блесны  - Ловля хищника';
$description='Особенности блесны в ловле хищной рыбы на водоёмах. Рассматриваемые темы: ';
$keywords='ловля хищника, блесны, ';
$table_name='hish_blesna';
$img_dir='hish_blesna';
try{if($count_uri_parts>2){throw new Exception();}else{
if(!isset($uri_parts[1])){
	$page=1;include $root.'/modul/l/hishnik/str_navigat.php';
	$main_content.='<section><h2>Ловля хищника</h2><div class="fon">'.$navigation.'<div class="cl"></div><h3>Блесны</h3></div>'.$search_content.'<div class="fon cl">'.$navigation.'</div>'.'</section>';
}//*****
...
$result=$MySQLsel->QuerySelect($sql);$res=mysql_fetch_array($result);
	...
	$keywords='ловля хищника, блёсны, '.$res['meta_k'];
	...
	$main_content.='<section><div class="fon"><h4>Блесны</h4><article><h3>'.$res['caption'].'</h3><div class="cl"></div><p><a href="/'.$uri_parts[0].'/" onclick="button_back(\'блесны/\');return false;" rel="nofollow">&#9668;&mdash;</a><br></p>'.$img.$res['full_text'].'<p><a href="/'.$uri_parts[0].'/" onclick="button_back(\'блесны/\');return false;" rel="nofollow">&#9668;&mdash; Вернуться в меню «Блесны»</a></p></article><div class="cl"></div></div></section>';
