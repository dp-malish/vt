...
// Убираю лишние пробелы внутри строки
    ...
    document.getElementById('links').value=newString.toLowerCase();
}
//************************************************************
function SetTranslitRuToLatChild(){
var text=document.getElementById('title').value;
var transl=new Array();
    transl['А']='A';     transl['а']='a';
    transl['Б']='B';     transl['б']='b';
...
// Убираю лишние пробелы внутри строки
    ...
    document.getElementById('links_child').value=newString.toLowerCase();
}